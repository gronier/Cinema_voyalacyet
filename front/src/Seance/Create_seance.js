            ...
            <div className="row justify-content-md-center">
                <div className="col col-lg-3">
                    ...
                    <Form onSubmit={handleSubmitSeance}>
                        ...
                        <Form.Group className="mb-3" controlId="IDFilm">
                            <Form.Label>ID Film</Form.Label>
                            <Form.Control type="number" placeholder="ID Film" value={seance.id_film}
                                          onChange={e => handleTextChangeSeance(e, "id_film")}/>
                        </Form.Group>
